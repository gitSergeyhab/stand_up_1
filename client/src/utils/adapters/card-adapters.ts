...
export const adaptComediansToCard: AdapterCardType<SubComedianCC> = (data) => ({
  ...
  extName: `${data.countryName || ''} ${data.comedianCity ? `(${data.comedianCity})` : ''}` ,
  extNameEn: data.comedianNameEn,
...
export type CardAdapters = ReturnType<typeof adaptEventsToCard> | ReturnType<typeof adaptShowsToCard> | ReturnType<typeof adaptComediansToCard>
