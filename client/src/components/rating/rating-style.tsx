...
export const RatingInput = styled.input.attrs({type: 'radio', name:'rating-2'})`
  display: none;
...
export const LineDiv = styled.div<{size: number}>`
  ...
  margin-top: 0.5rem;
  background: ${({ size }) => `linear-gradient(90deg, rgba(48,6,6,1) ${size - 5}%, rgba(255,215,0,1) ${size + 5}%);`};
`;
