...
import { AvatarContainer, Date, MyRate, NikDateContainer, RateContainer, UserImg, UserLink, VoteLi } from './vote-style';


export const Vote = ({vote} : {vote: DataRateCC}) => {
  ...
  return (
    <VoteLi>
      ...
      <NikDateContainer>
        <UserLink to={`/users/${userId}`}><h3>{userNik}</h3></UserLink>
